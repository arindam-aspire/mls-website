...
Next.js App Router page for route segment `[locale]/dashboard`. Thin wrapper that renders a feature screen.
...
4. Next.js App Router page for route segment `[locale]/dashboard`. Thin wrapper that renders a feature screen.
...
- Keep in sync when `app/[locale]/(main)/dashboard/page.tsx` changes.
