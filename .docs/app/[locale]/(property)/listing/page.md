...
Next.js App Router page for route segment `[locale]/listing`. Thin wrapper that renders a feature screen.

**Source:** `app/[locale]/(property)/listing/page.tsx`
...
4. Next.js App Router page for route segment `[locale]/listing`. Thin wrapper that renders a feature screen.
...
- Keep in sync when `app/[locale]/(property)/listing/page.tsx` changes.
