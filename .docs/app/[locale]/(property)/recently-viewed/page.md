...
Next.js App Router page for route segment `[locale]/recently-viewed`. Thin wrapper that renders a feature screen.

**Source:** `app/[locale]/(property)/recently-viewed/page.tsx`
...
4. Next.js App Router page for route segment `[locale]/recently-viewed`. Thin wrapper that renders a feature screen.
...
- Keep in sync when `app/[locale]/(property)/recently-viewed/page.tsx` changes.
