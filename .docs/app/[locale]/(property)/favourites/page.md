...
Next.js App Router page for route segment `[locale]/favourites`. Thin wrapper that renders a feature screen.

**Source:** `app/[locale]/(property)/favourites/page.tsx`
...
4. Next.js App Router page for route segment `[locale]/favourites`. Thin wrapper that renders a feature screen.
...
- Keep in sync when `app/[locale]/(property)/favourites/page.tsx` changes.
