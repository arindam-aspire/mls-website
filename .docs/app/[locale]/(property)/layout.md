...
**Source:** `app/[locale]/(property)/layout.tsx`
...
See source in `app/[locale]/(property)/layout.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `app/[locale]/(property)/layout.tsx` changes.
