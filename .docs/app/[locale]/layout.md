...
See source in `app/[locale]/layout.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `app/[locale]/layout.tsx` changes.
