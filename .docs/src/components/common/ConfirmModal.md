...
**Source:** `src/components/common/ConfirmModal.tsx` (Client Component)
...
See source in `src/components/common/ConfirmModal.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `src/components/common/ConfirmModal.tsx` changes.
