...
**Source:** `src/components/ui/button/index.tsx` (Client Component)
...
See source in `src/components/ui/button/index.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
