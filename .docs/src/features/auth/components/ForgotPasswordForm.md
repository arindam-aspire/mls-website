...
**Source:** `src/features/auth/components/ForgotPasswordForm.tsx` (Client Component)
...
See source in `src/features/auth/components/ForgotPasswordForm.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `src/features/auth/components/ForgotPasswordForm.tsx` changes.
