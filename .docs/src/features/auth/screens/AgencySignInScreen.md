...
**Source:** `src/features/auth/screens/AgencySignInScreen.tsx` (Client Component)
...
See source in `src/features/auth/screens/AgencySignInScreen.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `src/features/auth/screens/AgencySignInScreen.tsx` changes.
