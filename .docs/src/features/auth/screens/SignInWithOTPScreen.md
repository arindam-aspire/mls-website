...
**Source:** `src/features/auth/screens/SignInWithOTPScreen.tsx` (Client Component)
...
See source in `src/features/auth/screens/SignInWithOTPScreen.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `src/features/auth/screens/SignInWithOTPScreen.tsx` changes.
