...
**Source:** `src/features/auth/screens/SignInScreen.tsx` (Client Component)
...
See source in `src/features/auth/screens/SignInScreen.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `src/features/auth/screens/SignInScreen.tsx` changes.
