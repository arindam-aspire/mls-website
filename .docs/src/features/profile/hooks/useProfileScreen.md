...
- Provide role-based `pageTitle` (`common.personalAndBusinessProfile` for admin/agency, else `common.profile`) and `pageSubtitle` (`profile.pageSubtitleAgency`: “View and manage your personal and business information.” vs `profile.pageSubtitlePersonal`: “View and manage your personal information.”), plus button labels via `profile` / `common` i18n.
