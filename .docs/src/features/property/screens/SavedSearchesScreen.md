...
See source in `src/features/property/screens/SavedSearchesScreen.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
