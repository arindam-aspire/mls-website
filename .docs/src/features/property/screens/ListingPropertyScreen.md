...
See source in `src/features/property/screens/ListingPropertyScreen.tsx` for step-by-step behavior aligned with [application.md](../../application.md) (path relative may vary).
...
- Keep in sync when `src/features/property/screens/ListingPropertyScreen.tsx` changes.
