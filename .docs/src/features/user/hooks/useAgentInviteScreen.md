...
4. On success, show password-instruction step with `passwordSetupLink` rewritten onto `window.location.origin`.
...
| Handler | Behavior |
| --- | --- |
| `onOpenPasswordSetup` | Opens the origin-rewritten `passwordSetupLink` in a new tab |
