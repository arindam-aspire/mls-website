...
import {
  selectAgencyAvatarClassName,
  selectAgencyAvatarSelectedClassName,
} from "../constants/selectAgency.constants";
import type { AgencyListItem } from "../types/profile.types";

type SelectAgencyListItemProps = {
...
export function SelectAgencyListItem({
  agency,
  selected,
  disabled = false,
  onSelect,
  ariaLabel,
}: SelectAgencyListItemProps) {
  const displayName = agency.agency_name.trim() || agency.email.trim();
    ...
    >
      <Avatar
        ...
        className={cn(
          ...
          selected ? selectAgencyAvatarSelectedClassName : selectAgencyAvatarClassName,
        )}
      />
...
export type { SelectAgencyListItemProps };
