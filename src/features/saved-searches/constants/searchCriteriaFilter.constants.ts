...
export const SEARCH_CRITERIA_STATUS_OPTIONS = [
  { value: "buy", label: "Buy" },
  { value: "rent", label: "Rent" },
] as const;

export const DEFAULT_SEARCH_CRITERIA_PARAMS: SearchCriteriaParams = {
  status: "buy",
...
export function hasAdvancedFilters(params: SearchCriteriaParams) {
  return Boolean(
