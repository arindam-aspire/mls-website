...
export const DEFAULT_PHONE_INPUT_COUNTRY_CODE = "JO";

export function getPhoneInputCountryByCode(
  iso2: string,
): PhoneInputCountry | undefined {
  return PHONE_INPUT_COUNTRIES.find(
