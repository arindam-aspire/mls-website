...
export const protectedDrawerLogoLinkClass =
  "inline-flex min-w-0 shrink overflow-hidden rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 sm:max-w-[55%]";
...
export const protectedDrawerCloseButtonClass =
  "inline-flex !size-9 shrink-0 items-center justify-center !gap-0 !rounded-lg !px-0 !py-0 !text-white transition-colors hover:!bg-white/15 focus:outline-none focus-visible:ring-2 focus-visible:ring-white/40 sm:!size-11";
