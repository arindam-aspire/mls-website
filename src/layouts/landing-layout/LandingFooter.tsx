...
function GooglePlayBadge() {
  return (
    ...
    >
      ...
      <span className="flex flex-col leading-tight">
        <span className="text-[0.6rem] uppercase">Get it on</span>
      ...
      <div className="w-full px-6">
        <div className="flex flex-col gap-6 py-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:items-end">
            <p className="text-sm text-white/90">{t("downloadOurApp")}</p>
        ...
        <div className="flex flex-col gap-3 py-4 text-sm text-white/75 sm:flex-row sm:items-center sm:justify-between">
