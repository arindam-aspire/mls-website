...
export const publicMobileHeaderIconButtonClass =
  "inline-flex !size-9 shrink-0 items-center justify-center !gap-0 !rounded-lg !px-0 !py-0 text-text transition-colors hover:bg-surface focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary/40 sm:!size-11";

export const publicMobileHeaderIconClass = "size-6";
